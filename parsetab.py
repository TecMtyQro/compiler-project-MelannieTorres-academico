...
_lr_productions = [
  ...
  ('program -> STATIC VOID MAIN block','program',4,'p_program','lexer.py',120),
  ('block -> LEFT_CURLY_BRACKET expressions RIGHT_CURLY_BRACKET','block',3,'p_block','lexer.py',124),
  ('expressions -> expression','expressions',1,'p_expressions','lexer.py',128),
  ('expressions -> expression expressions','expressions',2,'p_expressions','lexer.py',129),
  ('expression -> read_expression SEMICOLON','expression',2,'p_expression','lexer.py',132),
  ('expression -> write_expression SEMICOLON','expression',2,'p_expression','lexer.py',133),
  ('expression -> RETURN arithmetic_expression SEMICOLON','expression',3,'p_expression','lexer.py',134),
  ('expression -> RETURN bool_expression SEMICOLON','expression',3,'p_expression','lexer.py',135),
  ('expression -> assign_expression SEMICOLON','expression',2,'p_expression','lexer.py',136),
  ('expression -> if_expression','expression',1,'p_expression','lexer.py',137),
  ('expression -> while_expression','expression',1,'p_expression','lexer.py',138),
  ('while_expression -> WHILE LEFT_PARENTHESIS condition RIGHT_PARENTHESIS block','while_expression',5,'p_while_expression','lexer.py',142),
  ('if_expression -> start_if','if_expression',1,'p_if_expression','lexer.py',146),
  ('if_expression -> start_if else_expression','if_expression',2,'p_if_expression','lexer.py',147),
  ('start_if -> IF LEFT_PARENTHESIS condition RIGHT_PARENTHESIS block','start_if',5,'p_start_if','lexer.py',150),
  ('else_expression -> ELSE IF LEFT_PARENTHESIS condition RIGHT_PARENTHESIS block else_expression','else_expression',7,'p_else_expression','lexer.py',153),
  ('else_expression -> ELSE block','else_expression',2,'p_else_expression','lexer.py',154),
  ('read_expression -> READ','read_expression',1,'p_read_expression','lexer.py',157),
  ('write_expression -> WRITE LEFT_PARENTHESIS string_literals RIGHT_PARENTHESIS','write_expression',4,'p_write_expression','lexer.py',161),
  ('arithmetic_datatypes -> INT','arithmetic_datatypes',1,'p_arithmetic_datatypes','lexer.py',165),
  ('arithmetic_datatypes -> FLOAT','arithmetic_datatypes',1,'p_arithmetic_datatypes','lexer.py',166),
  ('bool_datatypes -> BOOL','bool_datatypes',1,'p_bool_datatypes','lexer.py',169),
  ('string_datatypes -> STRING','string_datatypes',1,'p_string_datatypes','lexer.py',172),
  ('assign_expression -> CONST aux_assign_expression','assign_expression',2,'p_assign_expression','lexer.py',175),
  ('assign_expression -> aux_assign_expression','assign_expression',1,'p_assign_expression','lexer.py',176),
  ('assign_expression -> declaration_expression','assign_expression',1,'p_assign_expression','lexer.py',177),
  ('assign_expression -> aux2_assign_expression','assign_expression',1,'p_assign_expression','lexer.py',178),
  ('aux_assign_expression -> arithmetic_datatypes ID EQUALS arithmetic_expression','aux_assign_expression',4,'p_aux_assign_expression','lexer.py',182),
  ('aux_assign_expression -> bool_datatypes ID EQUALS bool_expression','aux_assign_expression',4,'p_aux_assign_expression','lexer.py',183),
  ('aux_assign_expression -> string_datatypes ID EQUALS string_expression','aux_assign_expression',4,'p_aux_assign_expression','lexer.py',184),
  ('aux2_assign_expression -> ID EQUALS arithmetic_expression','aux2_assign_expression',3,'p_aux2_assign_expression','lexer.py',187),
  ('aux2_assign_expression -> ID EQUALS bool_expression','aux2_assign_expression',3,'p_aux2_assign_expression','lexer.py',188),
  ('aux2_assign_expression -> ID EQUALS string_expression','aux2_assign_expression',3,'p_aux2_assign_expression','lexer.py',189),
  ('declaration_expression -> arithmetic_datatypes ID','declaration_expression',2,'p_declaration_expression','lexer.py',193),
  ('declaration_expression -> bool_datatypes ID','declaration_expression',2,'p_declaration_expression','lexer.py',194),
  ('declaration_expression -> string_datatypes ID','declaration_expression',2,'p_declaration_expression','lexer.py',195),
  ('arithmetic_expression -> arithmetic_literals ADD arithmetic_expression','arithmetic_expression',3,'p_arithmetic_expression','lexer.py',205),
  ('arithmetic_expression -> arithmetic_literals MINUS arithmetic_expression','arithmetic_expression',3,'p_arithmetic_expression','lexer.py',206),
  ('arithmetic_expression -> arithmetic_literals MULTIPLICATION arithmetic_expression','arithmetic_expression',3,'p_arithmetic_expression','lexer.py',207),
  ('arithmetic_expression -> arithmetic_literals DIVISION arithmetic_expression','arithmetic_expression',3,'p_arithmetic_expression','lexer.py',208),
  ('arithmetic_expression -> arithmetic_literals','arithmetic_expression',1,'p_arithmetic_expression','lexer.py',209),
  ('arithmetic_literals -> INT_LITERAL','arithmetic_literals',1,'p_arithmetic_literals','lexer.py',215),
  ('arithmetic_literals -> FLOAT_LITERAL','arithmetic_literals',1,'p_arithmetic_literals','lexer.py',216),
  ('arithmetic_literals -> ID','arithmetic_literals',1,'p_arithmetic_literals','lexer.py',217),
  ...
  ('string_expression -> STRING_LITERAL','string_expression',1,'p_string_expression','lexer.py',234),
  ('condition -> arithmetic_expression GT arithmetic_expression','condition',3,'p_condition','lexer.py',238),
  ('condition -> arithmetic_expression LT arithmetic_expression','condition',3,'p_condition','lexer.py',239),
  ('condition -> arithmetic_expression GET arithmetic_expression','condition',3,'p_condition','lexer.py',240),
  ('condition -> arithmetic_expression LET arithmetic_expression','condition',3,'p_condition','lexer.py',241),
  ('condition -> arithmetic_expression IS_EQUAL arithmetic_expression','condition',3,'p_condition','lexer.py',242),
  ('condition -> arithmetic_expression IS_NOT_EQUAL arithmetic_expression','condition',3,'p_condition','lexer.py',243),
  ('condition -> BOOL_LITERAL IS_EQUAL BOOL_LITERAL','condition',3,'p_condition','lexer.py',244),
  ('condition -> BOOL_LITERAL IS_NOT_EQUAL BOOL_LITERAL','condition',3,'p_condition','lexer.py',245),
]
