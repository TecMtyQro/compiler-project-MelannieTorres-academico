...
_lr_productions = [
  ...
  ('program -> STATIC VOID MAIN block','program',4,'p_program','parser.py',151),
  ('block -> LEFT_CURLY_BRACKET expressions RIGHT_CURLY_BRACKET','block',3,'p_block','parser.py',156),
  ('expressions -> expression','expressions',1,'p_expressions','parser.py',160),
  ('expressions -> expression expressions','expressions',2,'p_expressions','parser.py',161),
  ('expression -> read_expression SEMICOLON','expression',2,'p_expression','parser.py',164),
  ('expression -> write_expression SEMICOLON','expression',2,'p_expression','parser.py',165),
  ('expression -> RETURN arithmetic_expression SEMICOLON','expression',3,'p_expression','parser.py',166),
  ('expression -> RETURN bool_expression SEMICOLON','expression',3,'p_expression','parser.py',167),
  ('expression -> assign_expression SEMICOLON','expression',2,'p_expression','parser.py',168),
  ('expression -> if_expression','expression',1,'p_expression','parser.py',169),
  ('expression -> while_expression','expression',1,'p_expression','parser.py',170),
  ('while_expression -> WHILE LEFT_PARENTHESIS condition RIGHT_PARENTHESIS block','while_expression',5,'p_while_expression','parser.py',174),
  ('if_expression -> start_if','if_expression',1,'p_if_expression','parser.py',178),
  ('if_expression -> start_if else_expression','if_expression',2,'p_if_expression','parser.py',179),
  ('start_if -> IF LEFT_PARENTHESIS condition RIGHT_PARENTHESIS block','start_if',5,'p_start_if','parser.py',182),
  ('else_expression -> ELSE IF LEFT_PARENTHESIS condition RIGHT_PARENTHESIS block else_expression','else_expression',7,'p_else_expression','parser.py',185),
  ('else_expression -> ELSE block','else_expression',2,'p_else_expression','parser.py',186),
  ('read_expression -> READ','read_expression',1,'p_read_expression','parser.py',189),
  ('write_expression -> WRITE LEFT_PARENTHESIS string_literals RIGHT_PARENTHESIS','write_expression',4,'p_write_expression','parser.py',193),
  ('arithmetic_datatypes -> INT','arithmetic_datatypes',1,'p_arithmetic_datatypes','parser.py',197),
  ('arithmetic_datatypes -> FLOAT','arithmetic_datatypes',1,'p_arithmetic_datatypes','parser.py',198),
  ('bool_datatypes -> BOOL','bool_datatypes',1,'p_bool_datatypes','parser.py',201),
  ('string_datatypes -> STRING','string_datatypes',1,'p_string_datatypes','parser.py',204),
  ('assign_expression -> CONST aux_assign_expression','assign_expression',2,'p_assign_expression','parser.py',207),
  ('assign_expression -> aux_assign_expression','assign_expression',1,'p_assign_expression','parser.py',208),
  ('assign_expression -> declaration_expression','assign_expression',1,'p_assign_expression','parser.py',209),
  ('assign_expression -> aux2_assign_expression','assign_expression',1,'p_assign_expression','parser.py',210),
  ('aux_assign_expression -> arithmetic_datatypes ID EQUALS arithmetic_expression','aux_assign_expression',4,'p_aux_assign_expression','parser.py',214),
  ('aux_assign_expression -> bool_datatypes ID EQUALS bool_expression','aux_assign_expression',4,'p_aux_assign_expression','parser.py',215),
  ('aux_assign_expression -> string_datatypes ID EQUALS string_expression','aux_assign_expression',4,'p_aux_assign_expression','parser.py',216),
  ('aux2_assign_expression -> ID EQUALS arithmetic_expression','aux2_assign_expression',3,'p_aux2_assign_expression','parser.py',219),
  ('aux2_assign_expression -> ID EQUALS bool_expression','aux2_assign_expression',3,'p_aux2_assign_expression','parser.py',220),
  ('aux2_assign_expression -> ID EQUALS string_expression','aux2_assign_expression',3,'p_aux2_assign_expression','parser.py',221),
  ('declaration_expression -> arithmetic_datatypes ID','declaration_expression',2,'p_declaration_expression','parser.py',225),
  ('declaration_expression -> bool_datatypes ID','declaration_expression',2,'p_declaration_expression','parser.py',226),
  ('declaration_expression -> string_datatypes ID','declaration_expression',2,'p_declaration_expression','parser.py',227),
  ('arithmetic_expression -> arithmetic_literals ADD arithmetic_expression','arithmetic_expression',3,'p_arithmetic_expression','parser.py',237),
  ('arithmetic_expression -> arithmetic_literals MINUS arithmetic_expression','arithmetic_expression',3,'p_arithmetic_expression','parser.py',238),
  ('arithmetic_expression -> arithmetic_literals MULTIPLICATION arithmetic_expression','arithmetic_expression',3,'p_arithmetic_expression','parser.py',239),
  ('arithmetic_expression -> arithmetic_literals DIVISION arithmetic_expression','arithmetic_expression',3,'p_arithmetic_expression','parser.py',240),
  ('arithmetic_expression -> arithmetic_literals','arithmetic_expression',1,'p_arithmetic_expression','parser.py',241),
  ('arithmetic_literals -> INT_LITERAL','arithmetic_literals',1,'p_arithmetic_literals','parser.py',247),
  ('arithmetic_literals -> FLOAT_LITERAL','arithmetic_literals',1,'p_arithmetic_literals','parser.py',248),
  ('arithmetic_literals -> ID','arithmetic_literals',1,'p_arithmetic_literals','parser.py',249),
  ('string_literals -> STRING_LITERAL','string_literals',1,'p_string_literals','parser.py',255),
  ('string_literals -> ID','string_literals',1,'p_string_literals','parser.py',256),
  ('bool_expression -> BOOL_LITERAL AND bool_expression','bool_expression',3,'p_bool_expression','parser.py',260),
  ('bool_expression -> BOOL_LITERAL OR bool_expression','bool_expression',3,'p_bool_expression','parser.py',261),
  ('bool_expression -> BOOL_LITERAL','bool_expression',1,'p_bool_expression','parser.py',262),
  ('string_expression -> STRING_LITERAL','string_expression',1,'p_string_expression','parser.py',266),
  ('condition -> arithmetic_expression GT arithmetic_expression','condition',3,'p_condition','parser.py',270),
  ('condition -> arithmetic_expression LT arithmetic_expression','condition',3,'p_condition','parser.py',271),
  ('condition -> arithmetic_expression GET arithmetic_expression','condition',3,'p_condition','parser.py',272),
  ('condition -> arithmetic_expression LET arithmetic_expression','condition',3,'p_condition','parser.py',273),
  ('condition -> arithmetic_expression IS_EQUAL arithmetic_expression','condition',3,'p_condition','parser.py',274),
  ('condition -> arithmetic_expression IS_NOT_EQUAL arithmetic_expression','condition',3,'p_condition','parser.py',275),
  ('condition -> BOOL_LITERAL IS_EQUAL BOOL_LITERAL','condition',3,'p_condition','parser.py',276),
  ('condition -> BOOL_LITERAL IS_NOT_EQUAL BOOL_LITERAL','condition',3,'p_condition','parser.py',277),
]
